...
<svg viewBox="0 0 720 300" role="img" aria-label="A staircase rising left to right. Each step is a new version of you, shipped every three to six years, each one taller than the last, with the most recent step drawn in green.">
  <!-- axes -->
  <line x1="70" y1="250" x2="680" y2="250" stroke="currentColor" stroke-width="1" opacity="0.4"/>
  <line x1="70" y1="40" x2="70" y2="250" stroke="currentColor" stroke-width="1" opacity="0.4"/>
  <text transform="translate(44,150) rotate(-90)" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="13" fill="currentColor" opacity="0.5">how much of you has been rewritten</text>

  <!-- compounding staircase: each tread a new era, each riser taller than the last -->
  <path d="M70 250 H190 V210 H320 V158 H450 V96 H560 V44 H650"
        fill="none" stroke="currentColor" stroke-width="2.5" stroke-linejoin="round" stroke-linecap="round" opacity="0.85"/>
  <!-- latest segment in green -->
  <path d="M450 96 H560 V44 H650" fill="none" stroke="#56b947" stroke-width="3.5" stroke-linejoin="round" stroke-linecap="round"/>

  <!-- version dots + labels at each step -->
  <circle cx="190" cy="210" r="4.5" fill="currentColor"/>
  <text x="130" y="200" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="13" fill="currentColor" opacity="0.65">you 1.0</text>
  <circle cx="320" cy="158" r="4.5" fill="currentColor"/>
  <text x="255" y="148" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="13" fill="currentColor" opacity="0.65">you 2.0</text>
  <circle cx="450" cy="96" r="4.5" fill="currentColor"/>
  <text x="385" y="86" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="13" fill="currentColor" opacity="0.65">you 3.0</text>
  <circle cx="560" cy="44" r="5" fill="#56b947"/>
  <text x="600" y="40" font-family="Source Serif 4, Georgia, serif" font-size="13" fill="#56b947" font-style="italic">you, today</text>

  <!-- gap labels under the treads -->
  <text x="130" y="270" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12" fill="currentColor" opacity="0.45">~4 yrs</text>
  <text x="255" y="270" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12" fill="currentColor" opacity="0.45">~5 yrs</text>
  <text x="385" y="270" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12" fill="currentColor" opacity="0.45">~3 yrs</text>
  <text x="505" y="270" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12" fill="currentColor" opacity="0.45">~4 yrs</text>
</svg>
<figcaption>Treat yourself like an investment: every few years a new version ships, each one compounding on the last.</figcaption>
</figure>
...
<figure class="diagram">
<svg viewBox="0 0 720 330" role="img" aria-label="Three life problems — career, family, finance — each shown as two bars. A long faint bar is the usual decade-each pace; a shorter green bar is solving it faster. The time saved on the right is labelled time for more interesting problems.">
  <!-- decade gridlines -->
  <line x1="170" y1="50" x2="170" y2="250" stroke="currentColor" stroke-width="1" opacity="0.3"/>
  <line x1="340" y1="50" x2="340" y2="250" stroke="currentColor" stroke-width="1" opacity="0.3"/>
  <line x1="510" y1="50" x2="510" y2="250" stroke="currentColor" stroke-width="1" opacity="0.3"/>
  <line x1="680" y1="50" x2="680" y2="250" stroke="currentColor" stroke-width="1" opacity="0.3"/>
  <text x="170" y="272" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12" fill="currentColor" opacity="0.45">10 yrs</text>
  <text x="340" y="272" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12" fill="currentColor" opacity="0.45">20</text>
  <text x="510" y="272" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12" fill="currentColor" opacity="0.45">30</text>
  <text x="680" y="272" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12" fill="currentColor" opacity="0.45">40</text>

  <!-- Career -->
  <text x="160" y="78" text-anchor="end" font-family="Source Serif 4, Georgia, serif" font-size="14" fill="currentColor" opacity="0.7">Career</text>
  <rect x="170" y="62" width="240" height="14" rx="3" fill="none" stroke="currentColor" stroke-width="1.4" opacity="0.5"/>
  <rect x="170" y="62" width="135" height="14" rx="3" fill="#56b947" opacity="0.9"/>

  <!-- Family -->
  <text x="160" y="138" text-anchor="end" font-family="Source Serif 4, Georgia, serif" font-size="14" fill="currentColor" opacity="0.7">Family</text>
  <rect x="170" y="122" width="350" height="14" rx="3" fill="none" stroke="currentColor" stroke-width="1.4" opacity="0.5"/>
  <rect x="170" y="122" width="205" height="14" rx="3" fill="#56b947" opacity="0.9"/>

  <!-- Finance -->
  <text x="160" y="198" text-anchor="end" font-family="Source Serif 4, Georgia, serif" font-size="14" fill="currentColor" opacity="0.7">Finance</text>
  <rect x="170" y="182" width="500" height="14" rx="3" fill="none" stroke="currentColor" stroke-width="1.4" opacity="0.5"/>
  <rect x="170" y="182" width="300" height="14" rx="3" fill="#56b947" opacity="0.9"/>

  <!-- saved-time bracket -->
  <line x1="470" y1="225" x2="670" y2="225" stroke="#56b947" stroke-width="1.5" opacity="0.8"/>
  <line x1="470" y1="220" x2="470" y2="230" stroke="#56b947" stroke-width="1.5" opacity="0.8"/>
  <line x1="670" y1="220" x2="670" y2="230" stroke="#56b947" stroke-width="1.5" opacity="0.8"/>
  <text x="570" y="246" text-anchor="middle" font-family="Source Serif 4, Georgia, serif" font-size="12.5" fill="#56b947" font-style="italic">time for more interesting problems</text>

  <!-- legend -->
  <rect x="190" y="296" width="22" height="12" rx="3" fill="none" stroke="currentColor" stroke-width="1.4" opacity="0.5"/>
  <text x="220" y="306" font-family="Source Serif 4, Georgia, serif" font-size="12.5" fill="currentColor" opacity="0.6">the usual pace</text>
  <rect x="370" y="296" width="22" height="12" rx="3" fill="#56b947" opacity="0.9"/>
  <text x="400" y="306" font-family="Source Serif 4, Georgia, serif" font-size="12.5" fill="currentColor" opacity="0.6">solving it faster</text>
</svg>
<figcaption>Career, family, finance — a decade each at the usual pace. Growth is closing them faster, and spending what you save on better problems.</figcaption>
</figure>
...
Upon some research i came across this image from Wait But Why. As time goes by, many doors are closed to us, but many new doors open up. That tweet was referring to the red lines on the left, and I focus on the green lines on the right.
