...
_*01-May-1999 to 16-Sept-2026 -> 10000 days.*_
...
At twenty the list was born, basic in the way a twenty-year-old's list should be: vague and ambitious, stolen from other people's bucket lists. Every item believed that finishing it would fix something. Now I wipe it clean every few months, and I add things I wouldn't have dared to write down then: my own standup set, a three-Michelin-star dinner, the Annapurna circuit.

A mathematician would call this unbounded: every goal is finite, but there is no ceiling I cannot rewrite. The list is the proof: the 25-country version was just a term in the sequence. The kid who wrote the first version would find me cool as fuck. I owe him more than that though. I went from over-aggressive to relaxed in college. Or so people tell me. I only got here because that twenty-year-old asked for help and took advice. And read.
...
_*A closed list is the only version of this list I'd regret.*_
