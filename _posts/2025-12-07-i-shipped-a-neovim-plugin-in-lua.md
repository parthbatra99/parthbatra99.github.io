...
<svg viewBox="0 0 380 150" width="100%" height="auto" role="img" aria-label="A code editor split in two: the structure skeleton labelled me on the left, the dense code lines labelled AI on the right." font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif">
  <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
    <rect x="30" y="22" width="320" height="100" rx="8" stroke-width="2"/>
    <line x1="30" y1="42" x2="350" y2="42" stroke-width="1.5"/>
    <line x1="150" y1="42" x2="150" y2="122" stroke-width="1.5" stroke-dasharray="4 4" opacity="0.35"/>
    <path d="M70 56 V114 M70 56 H94 M70 114 H94" stroke-width="1.8"/>
    <path d="M82 70 V100 M82 70 H106 M82 100 H106" stroke-width="1.8" opacity="0.65"/>
    <g stroke-width="2">
      <line x1="168" y1="58" x2="226" y2="58"/>
      <line x1="180" y1="70" x2="248" y2="70"/>
      <line x1="180" y1="82" x2="218" y2="82"/>
      <line x1="168" y1="94" x2="238" y2="94"/>
      <line x1="180" y1="106" x2="258" y2="106"/>
      <line x1="168" y1="118" x2="208" y2="118"/>
    </g>
  </g>
  <g fill="currentColor" stroke="none">
    <circle cx="44" cy="32" r="2.4"/>
    <circle cx="54" cy="32" r="2.4"/>
    <circle cx="64" cy="32" r="2.4"/>
    <text x="100" y="140" text-anchor="middle" font-size="13">me</text>
    <text x="213" y="140" text-anchor="middle" font-size="13">AI</text>
  </g>
</svg>
